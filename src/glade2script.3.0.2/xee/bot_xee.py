...
i18n['en']['EMPTY']="%s"
i18n['en']['MSG']='Responce 1: %s'
def msgHandler(user,command,args,mess):
    return "MSG",'You requested: %s'%args

i18n['en']['HOOK2']='Responce 2: %s'
def hook2Handler(user,command,args,mess):
    return "HOOK2","hook2 called with %s"%(`(user,command,args,mess)`)

i18n['en']['XEEKILL']='Responce 3: static string'
def xeekillHandler(user,command,args,mess):
    return "XEEKILL"*int(args)
########################### user handlers stop ###################################
############################ bot logic start #####################################
